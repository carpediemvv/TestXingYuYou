...
import com.yancy.imageselector.utils.StatusBarUtils;
...
public class ImageSelectorActivity extends FragmentActivity implements ImageSelectorFragment.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StatusBarUtils.setWindowStatusBarColor(ImageSelectorActivity.this,R.color.colorStatus);
    ...
    private void crop(String imagePath, int aspectX, int aspectY, int outputX, int outputY) {
        ...
        Uri photoURII = FileProvider.getUriForFile(this, this.getApplicationContext().getPackageName() + ".provider", new File(imagePath));
        intent.setDataAndType(photoURII, "image/*");
