...
public class PostDeleteDialog {
    ...
    public PostDeleteDialog(Context context) {
        this.context = context;
        AlertDialog.Builder builder = new AlertDialog.Builder(context);
        View view = LayoutInflater.from(context).inflate(R.layout.dialog_delete_post, null);
     ...
     * @param msg
     */
    public PostDeleteDialog(Context context, String msg) {
        this.context = context;
        AlertDialog.Builder builder = new AlertDialog.Builder(context);
