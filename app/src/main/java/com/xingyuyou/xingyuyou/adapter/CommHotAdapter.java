...
public class CommHotAdapter extends RecyclerView.Adapter {
    ...
    public CommHotAdapter(int i, Fragment fragment, List<PostListBeanTest> listData) {
        mListData = listData;
        mFragment = fragment;
        fragmentType = i;
    }
...
/*     if(holder instanceof ItemViewHolder && (getItemViewType(position) == 6){
*
*   //第三部
*
* }*/
        ...
        if (holder instanceof ItemViewHolder && (getItemViewType(position) == TYPE_ONE_PIC
                ...
                || getItemViewType(position) == TYPE_THREE_PIC || getItemViewType(position) == TYPE_THREE_VIDEO)) {
          ...
          /*  if(mListData.get(position - 1).getVod_id()!=null&&mListData.get(position - 1).getVod_id().length()>0){
                ((ItemViewHolder) holder).alpha.setVisibility(View.VISIBLE);
            }*/
            ...
            ((ItemViewHolder) holder).mPostContent.setText(SpanStringUtils.getEmotionContent(mActivity, ((ItemViewHolder) holder).mPostContent, mListData.get(position - 1).getMessage()));
    ...
    class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        public ItemViewHolder(View itemView) {
            ...
            mAliyunVodPlayerView = (AliyunVodPlayerView) itemView.findViewById(R.id.video_view);
        }
    }
