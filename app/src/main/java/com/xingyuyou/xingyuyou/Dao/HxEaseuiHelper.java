package com.xingyuyou.xingyuyou.Dao;
...
//        }
        //getRobotList UserDao dao=new UserDao(App.mContext);
        Map<String, EaseUser> contactList = demoModel.getContactList();
        ...
        if(user == null){
            ...
            if (TextUtils.isEmpty(user.getUsername())){//如果名字为空，则显示环信号码
    ...
    private void initDbDao() {
        ...
        demoModel = new DemoModel(appContext);
    }
        ...
        messageListener = new EMMessageListener() {
            ...
            public void onMessageReceived(List<EMMessage> messages) {
                for (EMMessage message : messages) {
                    Intent intent=new Intent("easeUiSendMessage");
...
//                    dao.saveContactList(users);
                    ...
                    for(String str:contactLists.keySet()){
                        easeUser= contactLists.get(str);
                        users.add(easeUser);
                    }

                    demoModel.saveContactList(users);
