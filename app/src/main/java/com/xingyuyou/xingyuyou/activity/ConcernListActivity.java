...
import com.xingyuyou.xingyuyou.adapter.ConcernListAdapter;
...
public class ConcernListActivity extends AppCompatActivity {
    ...
    private ConcernListAdapter fansListAdapter;
    ...
    private void setData() {
        ...
        fansListAdapter = new ConcernListAdapter(dataBean,ConcernListActivity.this,Integer.parseInt(tag));
        ...
        listView_fansList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                if (!UserUtils.logined()) {
                    IntentUtils.startActivity(ConcernListActivity.this, LoginActivity.class);
                    return;
                }else {
                    if (UserUtils.getUserId().equals(dataBean.get(position).uid)){
                        startActivity(new Intent(ConcernListActivity.this, UserPageActivity.class));
                    }else {
                        Intent intent=new Intent(ConcernListActivity.this, OtherPageActivity.class);
                        intent.putExtra("re_uid",dataBean.get(position).uid);
    ...
    private void initView() {
        listView_fansList = (ListView) findViewById(R.id.listView_ConcernList);
        View loadingData = View.inflate(ConcernListActivity.this, R.layout.default_loading, null);
        ...
        TextView textView = new TextView(ConcernListActivity.this);
        textView.setText("");
    ...
    protected void onResume() {
        super.onResume();
        DCAgent.resume(this);
        DCPage.onEntry("ConcernListActivity");
    }
    ...
    protected void onPause() {
        super.onPause();
        DCAgent.pause(this);
        DCPage.onExit("ConcernListActivity");
    }
}
