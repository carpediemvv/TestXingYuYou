        ...
        mCommHotAdapter.imageSetOnclick(new CommHotAdapter.ImageInterface() {
            ...
            public void onclick(int position) {
                if (!UserUtils.logined()) {
                    IntentUtils.startActivity(SearchCommuListActivity.this, LoginActivity.class);
                    return;
                } else {
                    if (UserUtils.getUserId().equals(mPostAdapterList.get(position-1).getUid())) {
                        startActivity(new Intent(SearchCommuListActivity.this, UserPageActivity.class));
                    } else {
                        Intent intent = new Intent(SearchCommuListActivity.this,OtherPageActivity.class);
