...
public class ClassifyAllFragment extends Fragment {
 ...
 /*               if (postListBEan.getRelation() == 0) {
    ...
    public void initData(int PAGENUMBER) {
        ...
        OkHttpUtils.post()//
                ...
                .addParams("type",bundle.getString("attribute"))
    ...
    private void initView() {
        ...
        mCommHotAdapter = new CommSortAdapter(getActivity(), mPostAdapterList);
        ...
        loadingData = View.inflate(getActivity(), R.layout.default_loading, null);
        ...
        //滑动加载更多
        //点击头像跳转
        mCommHotAdapter.imageSetOnclick(new CommSortAdapter.ImageInterface() {
            @Override
