...
import com.xingyuyou.xingyuyou.activity.FriendActivity;
...
public class EasyFragment extends EaseConversationListFragment {
    ...
    protected void initView() {
        chat_line = (LinearLayout) getActivity().findViewById(R.id.chat_line);
        ...
        titleBar.setSixin("私信");
        titleBar.setTitle("");
        titleBar.setRightImageResource(R.drawable.ic_friend);
    ...
    protected void setUpView() {
        ...
        if(conversationList.size()==0){
            chat_line.setBackgroundResource(R.drawable.ic_back_im);
        }else {
            chat_line.setBackgroundResource(R.color.common_bg);
