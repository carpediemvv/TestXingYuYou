 ...
 */
public class MyReplyPostListFragment extends BaseFragment {
    ...
    public static MyReplyPostListFragment newInstance(String content) {
        Bundle args = new Bundle();
        args.putString("ARGS", content);
        MyReplyPostListFragment fragment = new MyReplyPostListFragment();
    ...
    public void onResume() {
        super.onResume();
        DCPage.onEntry("MyReplyPostListFragment");
    }

    @Override
    public void onPause() {
        super.onPause();
        DCPage.onExit("MyReplyPostListFragment");
    }
}
