...
import com.xingyuyou.xingyuyou.adapter.AllPostAdapter;
...
public class CommNewFragment extends BaseFragment {
    ...
    private AllPostAdapter mCommHotAdapter;
        ...
        OkHttpUtils.post()//
                ...
                .execute(new StringCallback() {
                    ...
                    public void onResponse(String response, int id) {
                        Log.d("whjwhj",response.toString());
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mCommHotAdapter = new AllPostAdapter(3,this, mPostAdapterList);
        //删除帖子
       /* mCommHotAdapter.setOnItemLongClickLitener(new AllPostAdapter.OnItemLongClickLitener() {
            @Override
        ...
        //点击头像跳转
        mCommHotAdapter.imageSetOnclick(new AllPostAdapter.ImageInterface() {
            @Override
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                switch (newState) {
                    case RecyclerView.SCROLL_STATE_SETTLING:
                        ...
                        Glide.with(CommNewFragment.this).pauseRequests();
                        //刷新
                        break;
                    case RecyclerView.SCROLL_STATE_IDLE:
                        //  Log.i("Main", "视图已经停止滑动");
                        Glide.with(CommNewFragment.this).resumeRequests();
                        break;
    ...
    public void onResume() {
        super.onResume();
        DCPage.onEntry("CommNewFragment");
    }

    @Override
    public void onPause() {
        super.onPause();
        DCPage.onExit("CommNewFragment");
    }
    @Override
    public void onStop() {
        super.onStop();
    ...
    public void onDestroy() {
        super.onDestroy();
        OkHttpUtils.getInstance().cancelTag(CommNewFragment.this);
    }
