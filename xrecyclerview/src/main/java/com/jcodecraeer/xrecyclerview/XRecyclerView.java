...
public class XRecyclerView extends RecyclerView {
    ...
    public void loadMoreComplete() {
        ...
        System.out.println("previousTotal size is " + previousTotal + "------ getlayout count is " + getLayoutManager().getItemCount());
...
//            System.out.println("1" + (layoutManager.getChildCount() > 0));
//            System.out.println("2" + (lastVisibleItemPosition > layoutManager.getItemCount() - 1));
//            System.out.println("3" + (layoutManager.getItemCount() > layoutManager.getChildCount()));
//            System.out.println("4" + isnomore);
//            System.out.println("4" + (mRefreshHeader.getState() < ArrowRefreshHeader.STATE_REFRESHING));
            if (layoutManager.getChildCount() > 0 && lastVisibleItemPosition >=
                    layoutManager.getItemCount() - 1 &&  layoutManager.getItemCount() >
                    layoutManager.getChildCount() && !isnomore && mRefreshHeader.getState() <
    ...
    public class WrapAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public void onAttachedToRecyclerView(RecyclerView recyclerView) {
            ...
            if(manager instanceof GridLayoutManager) {
                ...
                if (gridManager.getSpanSizeLookup() == null) {
                    gridManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
                        @Override
                        public int getSpanSize(int position) {
                            int realSpanSize = 1;
                            if ((isHeader(position) || isFooter(position))) {
                                realSpanSize = gridManager.getSpanCount();
                            }
                            return realSpanSize;
                        }
                    });
                    ...
                    gridManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
                        ...
                        public int getSpanSize(int position) {
                            ...
                            if ((isHeader(position) || isFooter(position))) {
                                ...
                                if (adapter.getItemViewType(6) == 1) {
                                    realSpanSize = 2;
                                }
                            }*/
                            return realSpanSize;
