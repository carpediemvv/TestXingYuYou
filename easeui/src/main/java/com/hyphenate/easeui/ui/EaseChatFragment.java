...
//        messageList.setAvatarShape(1);
    ...
    protected void setUpView() {
      //titleBar.setTitle(name);
        ...
        easeUser.setAvatar(fragmentArgs.getString("headImage"));
        ...
        if (chatType == EaseConstant.CHATTYPE_SINGLE) {
            ...
            titleBar.setRightImageResource(R.drawable.ic_iction_jubao);
    ...
    protected void sendMessage(EMMessage message){
        ...
        if(chatFragmentHelper != null){
            //set extension
            message.setAttribute("to_user_id", getArguments().getString("userId", ""));
            message.setAttribute("to_headportrait", getArguments().getString("to_headportrait", ""));
            message.setAttribute("to_username", getArguments().getString("nickname", ""));
