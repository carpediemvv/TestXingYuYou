...
public class EaseSmileUtils {
	...
	public static final String ee_36 = "[(Da)]";
	public static final String ee_37= "	[(*b)]";
	public static final String ee_38 = "[(#c)]";
	public static final String ee_39 = "[(Rd)]";
	public static final String ee_40 = "[({e)]";
	public static final String ee_41 = "[:'(f]";
	public static final String ee_42 = "[:|g]";
	public static final String ee_43 = "[(ah)]";
	public static final String ee_44 = "[8o|i]";
	public static final String ee_45 = "[8-|j]";
	public static final String ee_46 = "[+o(k]";
	public static final String ee_47 = "[<o)l]";
	...
	public static final String ee_52 = "[^o)q]";
	public static final String ee_53 = "[8-)r]";
	public static final String ee_54 = "[(|)s]";
	public static final String ee_55 = "[(u)t]";
	public static final String ee_56 = "[(S)u]";
	public static final String ee_57 = "[(*)v]";
	public static final String ee_58 = "[(#)w]";
	public static final String ee_59 = "[(R)x]";
	public static final String ee_60 = "[({)y]";
	public static final String ee_61 = "[(})z]";
	public static final String ee_62 = "[(k)a]";
	public static final String ee_63 = "[(Fa)]";
	public static final String ee_64 = "[(W)b]";
	public static final String ee_65 = "[(D)c]";
	public static final String ee_66 = "[(D)d]";
	public static final String ee_67= "[(*)e]";
	public static final String ee_68 = "[(#)f]";
	public static final String ee_69 = "[(R)g]";
	public static final String ee_70 = "[({)h]";
